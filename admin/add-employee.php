                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
											 <select class="col-12 m-t-20 p-l-0" style="display:block;" name="em_gender">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="date" class="form-control datetimepicker" placeholder="Birth Date"
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
								  ...
								  <div class="row clearfix">
                                    ...
                                    <div class="form-group">
                                       <div class="form-line">
                                             <input type="text" class="form-control datetimepicker" placeholder="Username"
                                            name="username" >
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                             <input type="password" class="form-control datetimepicker" placeholder="Password"
                                            name="em_password" >
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                             <input type="file" class="form-control datetimepicker" placeholder="Photo"
                                            name="em_image" >
