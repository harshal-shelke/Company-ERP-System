                                ...
                                <table class="table table-hover js-basic-example contact_list"  id="table_emp">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                          ...
                                          $query = "SELECT emp_leave.id,emp_leave.em_id,emp_leave.leave_type,emp_leave.start_date,emp_leave.end_date,emp_leave.apply_date,emp_leave.leave_status,employee.first_name,emp_leave.comment FROM emp_leave INNER JOIN employee on emp_leave.em_id=employee.id;
";
                                        ...
                                        echo'<tr class="odd gradeX">
                                            ...
                                            <td class="center">'.$data["apply_date"].'</td>';
                                               ...
                                               <a href="status_update.php?id='.$data["id"].'&leave_status=Not Approve"> <div class="badge col-green" id="leave_status">Approved</div></a>
                                            </td>';
												  }
												  else{
													   echo' <td class="center" id="status">
                                               <a href="status_update.php?id='.$data["id"].'&leave_status=Approve"> <div class="badge col-green" id="leave_status">Not Approved</div></a>
                                            </td>';
												  }
										    echo'
 ...
 $("#table_emp").on("click", ".delete_video", function(){
  var id =  $(this).data('userid');
      if (confirm('Confirm delete the Employee leave?')){
       window.location = "delete_leave.php?id="+id;
    }else{
