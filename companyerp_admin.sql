...
--
-- Host: localhost:3306
-- Generation Time: May 09, 2022 at 06:52 PM
...
CREATE TABLE `attendance` (
  ...
  `status1` varchar(64) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `attendance` (`id`, `emp_id`, `atten_date`, `signin_time`, `signout_time`, `status1`) VALUES
(3, '1', '2022-03-12', '19:40:00', '19:40:00', 'Present'),
(4, '3', '2022-03-12', '19:40:00', '19:40:00', 'Present'),
(6, '6', '2022-03-12', '09:00:00', '06:00:00', 'Present'),
(8, '2', '2022-03-11', '21:04:00', '09:05:00', 'Present'),
(9, '2', '2022-03-11', '21:04:00', '09:05:00', 'Present'),
(10, '2', '2022-03-11', '21:04:00', '09:05:00', 'Present'),
(11, '2', '2022-03-11', '21:04:00', '09:05:00', 'Present'),
(12, '2', '2022-03-11', '21:14:00', '11:16:00', 'Present'),
(13, '2', '2022-03-22', '06:34:00', '08:30:00', 'Present'),
(14, '7', '2022-03-11', '09:10:00', '17:30:00', 'Present'),
(15, '6', '2022-05-05', '22:02:00', '22:05:00', 'Absent');
...
--
-- Dumping data for table `drt`
--

INSERT INTO `drt` (`id`, `user`, `password`) VALUES
(1, 'john', NULL),
(2, 'admin', '123');
...
CREATE TABLE `employee` (
  ...
  `des_id` varchar(255) DEFAULT NULL,
...
INSERT INTO `employee` (`id`, `em_id`, `em_code`, `des_id`, `dep_id`, `first_name`, `last_name`, `em_email`, `em_password`, `em_role`, `em_address`, `status`, `em_gender`, `em_phone`, `em_birthday`, `em_blood_group`, `em_joining_date`, `em_contact_end`, `em_image`, `em_nid`, `usertype`, `username`) VALUES
(2, NULL, NULL, 'Software developer', 2, 'Rohit', 'dryuh', 'rohit@gmail.com', 'rohit', 'EMPLOYEE', 'pune', 'ACTIVE', 'Male', '7845285212', NULL, NULL, '12/02/2000', NULL, NULL, NULL, '1', 'rohit@gmail.com'),
(3, NULL, NULL, 'developer', 0, 'john', 'patel', 'john@gmail.com', 'john', 'EMPLOYEE', 'india', 'ACTIVE', 'Male', '78415421', '2022-03-11', NULL, '2022-03-11', NULL, NULL, NULL, NULL, ''),
(4, NULL, NULL, 'developer', 0, 'john', 'patel', 'john@gmail.com', 'john', 'EMPLOYEE', 'india', 'ACTIVE', 'Male', '78415421', '2022-03-11', NULL, '2022-03-11', NULL, NULL, NULL, NULL, ''),
(6, NULL, NULL, 'test', 0, 'test', 'test', 'test@test.com', 'asd123!@#', 'EMPLOYEE', 'test', 'ACTIVE', 'Male', '1234567', '2022-03-12', NULL, '2020-06-08', NULL, NULL, NULL, NULL, 'testt'),
(7, NULL, NULL, 'Developer', 0, 'Harshal', 'Shelke', 'harshal@gmail.com', 'harshal123', 'EMPLOYEE', 'Sutargali Sakri', 'ACTIVE', 'Male', '7052872953', '2003-06-08', NULL, '2019-01-15', NULL, NULL, NULL, NULL, 'harshal123'),
(8, NULL, NULL, 'hhh', 0, 'hh', 'hh', 'ref@gmail.com', 'jj', 'EMPLOYEE', 'hjj', 'ACTIVE', 'Male', '455667788', '2022-05-12', NULL, '2022-05-13', NULL, 'https://companyerp.mycloudspace.in/admin/upload/account-image-placeholder.png', NULL, NULL, 'jj'),
(9, NULL, NULL, 'hhh', 0, 'hh', 'hh', 'ref@gmail.com', '', 'EMPLOYEE', 'hjj', 'ACTIVE', 'Male', '455667788', '2022-05-12', NULL, '2022-05-13', NULL, 'https://companyerp.mycloudspace.in/admin/upload/account-image-placeholder.png', NULL, NULL, 'jj'),
(10, NULL, NULL, 'Developer', 0, 'Sam', 'Roavr', 'sam@gmail.com', 'sam', 'EMPLOYEE', 'nashik', 'ACTIVE', 'Male', '5654567678', '2022-05-14', NULL, '2022-05-20', NULL, 'https://companyerp.mycloudspace.in/admin/upload/account-image-placeholder.png', NULL, NULL, 'sam'),
(11, NULL, NULL, 'Developer', 0, 'Sam', 'Roavr', 'sam@gmail.com', 'sam', 'EMPLOYEE', 'nashik', 'ACTIVE', 'Male', '5654567678', '2022-05-14', NULL, '2022-05-20', NULL, 'https://companyerp.mycloudspace.in/admin/upload/account-image-placeholder.png', NULL, NULL, 'sam'),
(12, NULL, NULL, 'Developer', 0, 'rohan', 'trggf', 'rohan@gmail.com', 'rohan', 'EMPLOYEE', 'ashik', 'ACTIVE', 'Male', '56545676545', '2022-05-19', NULL, '2022-05-12', NULL, 'https://companyerp.mycloudspace.in/admin/upload/account-image-placeholder.png', NULL, NULL, 'rohan');
...
INSERT INTO `emp_leave` (`id`, `em_id`, `typeid`, `leave_type`, `start_date`, `end_date`, `leave_duration`, `apply_date`, `reason`, `leave_status`, `comment`, `leave_from`, `leave_to`) VALUES
(3, '1', 0, 'Privilege Leave', '2022-03-12', '2022-03-12', NULL, '2022-03-11', NULL, 'Approve', 'test', NULL, NULL),
(4, '1', 0, 'Sick Leave', '2022-03-13', '2022-03-14', NULL, '2022-03-12', NULL, 'Approve', 'test', NULL, NULL),
(5, '1', 0, 'Sick Leave', '2022-03-15', '2022-03-15', NULL, '2022-03-14', NULL, 'Approve', 'test', NULL, NULL),
(6, '1', 0, 'Sick Leave', '2022-03-15', '2022-03-15', NULL, '2022-03-14', NULL, 'Approve', 'test', NULL, NULL),
(7, '1', 0, 'Casual Leave', '2022-03-20', '2022-03-31', NULL, '2022-03-18', NULL, 'Not Approve', '', NULL, NULL);
...
(5, 'womans day', '2022-03-08', '2022-03-09', NULL, NULL),
(6, 'test', '2022-03-12', '2022-03-12', NULL, NULL);
...
CREATE TABLE `pro_expenses` (
  ...
  `expense_by` varchar(255) DEFAULT NULL,
...
INSERT INTO `pro_expenses` (`id`, `pro_id`, `assign_to`, `details`, `amount`, `date`, `category`, `expense_by`, `product_name`) VALUES
(4, 0, NULL, 'Salary to employees', '2000', '02/02/2021', 'Salary', 'smith', NULL);
