                ...
                <ul class="list">
                    <li class="sidebar-user-panel active">
                        ...
                        <div class="profile-usertitle">
                            <div class="sidebar-userpic-name">Employee</div>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="all_emp.php">All Employee</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                           <!-- <li>
                            ...
                            <li>
                                <a href="emp-attend.php">Employee Attendance</a>
                            </li>
                        </ul>
                    </li>
                  <!--   <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="all-leave.php">All Leave Request</a>
                            </li>
                          
                            <li>
                                <a href="add-leave.php">New Leave Request</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="all-holidays.php">All Holidays</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="department.php">All Departments</a>
                            </li>
